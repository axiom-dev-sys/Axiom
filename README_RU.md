...
Axiom Engine 1.5.x завершает создание первого игрового прототипа.

Движок теперь объединяет редактор второго поколения с полноценным Runtime,
главным меню, игровыми системами, искусственным интеллектом врага,
балансом, игровым интерфейсом и завершённым игровым циклом.

На данный момент Axiom предоставляет полноценную основу
для создания 2D-игр, включая рендеринг, ECS, систему сцен,
Runtime, игровые механики, управление ресурсами,
отладочные инструменты и встроенный редактор.

Следующий этап разработки будет посвящён расширению возможностей
движка и созданию более крупных игровых проектов.