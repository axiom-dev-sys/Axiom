...
Первое поколение редактора Axiom.

Редактор включает встроенные инструменты для работы со сценами,
сущностями, ресурсами, отладки, управления Runtime и разработки игр.
...
Axiom Engine 1.2.x завершает первое поколение встроенного редактора, развивая архитектуру Runtime полноценными инструментами для редактирования сцен, управления ресурсами, отладки и выполнения игры.

Теперь движок предоставляет надёжную основу для разработки 2D-игр, включая рендеринг, ECS, Runtime, систему сцен, управление ресурсами, сериализацию, инструменты отладки и встроенный редактор первого поколения.

Следующие версии будут направлены на развитие игровых систем, дальнейшее совершенствование редактора, улучшение рендеринга и создание новых инструментов разработки.